...
#  https://github.com/mat-der-D/toy-box/blob/master/cards2/cards.py
#  tottemo kan sya
...
if __name__ == '__main__':
    ...
    class BaccaratCard(Card):
        ...
        def _strength(self):
            if self.is_joker:
                return 0
            if self.is_face or self.number == 10:
                return 0
    ...
    #card1 = deck.draw()
    #print(card0, card1)
    #print(card0.number, card1.number)
    #print(card0.suit, card1.suit)
    #print("")
    #print("")
